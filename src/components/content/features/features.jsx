...
export default function Features() {
  return (
    <>
      ...
      >
        <Card
          title="Hindusthani Music"
          children="Hindustani classical music is
...
music in general."
        ...
        <Card
          title="Bharatanatyam"
          children="Bharatanatyam is a dance
...
stories and devotions."
        ...
        <Card
          title="Kathak"
          children="Kathak is characterized by
...
Kathak is danced bv both males and females"
      ...
      >
        {" "}
        Any Questions? Ping Us at{" "}
        <a href="mailto:natarajainstitute@gmail.com">
          natarajainstitute@gmail.com
        </a>{" "}
        or<a href="tel:+919480079135">+919480079135</a>
      </Heading>
    </>
  );
}
